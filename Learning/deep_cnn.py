...
tf.app.flags.DEFINE_integer('batch_size', 64, """Nb of images in a batch.""")
tf.app.flags.DEFINE_integer('epochs_per_decay', 350, """Nb epochs per decay""")
tf.app.flags.DEFINE_integer('learning_rate', 8, """100 * learning rate""")
...
def softmax_preds(images, ckpt_path, return_logits=False):
  ...
  with tf.Session() as sess:
    ...
    for batch_nb in xrange(0, int(nb_batches+1)):
      ...
      preds[range(start, end), :] = sess.run([output], feed_dict=feed_dict)[0]
